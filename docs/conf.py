...
htmlhelp_basename = 'Strippingdoc'
...
man_pages = [
    (master_doc, 'stripping', 'Stripping Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Stripping', 'Stripping Documentation',
     author, 'Stripping', 'One line description of project.',
     'Miscellaneous'),
]
...
ddidier_sphinxdoc_image_tag = 'a51d062fd49526a5eb88f5f4b475474f63fd72de26b9a2cae76d99d72a223de7'
